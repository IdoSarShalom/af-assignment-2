...
print('Minimax test 1 (correct Minimax value): ', test_1)
print('Alphabeta test 1 (correct Minimax value): ', test_1_ab)
...
print('Minimax test 2 (correct Minimax value): ', test_2)
print('Alphabeta test 2 (correct Minimax value): ', test_2_ab)
